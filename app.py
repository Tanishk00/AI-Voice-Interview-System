...
# --------------------------------------------------
# Utility: Limit text size and Database connections
# --------------------------------------------------
...
def init_db():
    ...
    try:
        ...
        """)
        print("✅ Added resume_email column to interview_results table")
...
Thank you for completing the AI-based interview.

Here is your interview evaluation scorecard:
